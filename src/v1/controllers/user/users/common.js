...
module.exports.updateLocation = async (req,res,next)=>{
  try {
    ...
    const updatedUser = await usersService.updateLocation(user,location)
...
module.exports.verifyPhone = async (req,res,next) => {
  try {
    ...
    const response = await usersService.verifyPhoneNumber(user)
...
module.exports.deleteSavedPlace = async (req, res, next) => {
  try {
    ...
    const savedPlaces = await usersService.deleteSavedPlace( placeId);
